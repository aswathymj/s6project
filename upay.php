  ...
  <?php
    ...
    while($row=mysqli_fetch_array($result))
    {
     ...
     echo"<br><br><br><br><br><br><br><br>";
      echo "<br> <br><br><br><br>Booking Number        : ".$row['bookno']."<br>";
      //echo "<br>Consumer Number    :".$row1['con']."<br>";
      //echo "<br>Name               :".$row1['name']."<br>";
      //echo "<br>Address            :".$row1['address']."<br>";
    
      //echo "<br>Phone Number       :".$row1['phone']."<br>";
      //echo "<br>City               :".$row1['city']."<br>";
      //echo "<br>District           :".$row1['district']."<br>";
      echo "<br>Requested Date     :".$row['rdate']."<br>";
      echo "<br>Cylinder    :".$row['cylinder']."<br>";
      $e=$row['cylinder'];
   
      $query1="select *from tbl_cyl where cyl_name='$e'";
      $result1=mysqli_query($con,$query1);
   
    while($row1=mysqli_fetch_array($result1))
    {
      $amount=$row1['cyl_price'];
    }
    ...
    <?php
      ...
      echo "<br><br><br>";
        ...
        // echo "<a class='pay' href='p.php'>Proceed</a>";
       
      }
      ?>
      <button><a href="p.php?amount=<?php echo $amount;?>">Proceed</button><br><br>
      
      <?php
      // $_session["amoun"]=$amount;
      ?>

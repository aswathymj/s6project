...
<div class="users" id="users">
  ...
  <table class="table1"  cellpadding="20" border="1" width="100%" height="180%"><br><br><br><br><br><br><br>
    <tr>
  ...
  <?php
   require("connection.php");
    $query = "SELECT *,tbl_books.status FROM tbl_books JOIN tbl_con  ON tbl_books.con_id = tbl_con.con_id";
    ...
    while($row=mysqli_fetch_array($result))
    {
      ...
      echo "<td>";
      if($row['status']==1){
           echo "<a class='active' href='amangbstatus.php?id=",$row['book_id'],"'>Pending</a>";

      }
      else{
        echo "<a class='deactive' href='amangbstatus.php?id=",$row['book_id'],"'>Confirmed</a>";

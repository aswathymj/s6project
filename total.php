...
<div class="users" id="users">
  ...
  <table class="table1" align="center" cellpadding="20" border="2" width="100%" height="170%"><br><br><br><br><br><br><br>
    <tr>
      <th>NAME</th>
      <th>EMAIL</th>
  ...
  <?php
   require("connection.php");
    ...
    while($row=mysqli_fetch_array($result))
    {
      ...
      echo "<td>";
      if($row['status']==1){
           echo "<a class='active' href='status.php?id=",$row['uid'],"'>Active</a>";
      }
      else{
        echo "<a class='deactive' href='status.php?id=",$row['uid'],"'>Deactive</a>";
      }
      echo"</td>";
      echo "<tr> </tr>";
      echo "<tr> </tr>";

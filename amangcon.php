...
<div class="users" id="users">
  ...
  <table class="table1"  cellpadding="20" border="1" width="80%" height="150%"><br><br><br><br><br><br><br>
    <tr>
  ...
  <?php
   require("connection.php");
    ...
    while($row=mysqli_fetch_array($result))
    {
     ...
     echo"<td>";
     echo"<img src='uploads/".$row['proof']."' width=80 height=60>";
     echo"</td>";
      echo "<td>";
      if($row['status']==1){
           echo "<a class='active' href='amagstatus.php?id=",$row['con_id'],"'>Pending</a>";

      }
      else{
        echo "<a class='deactive' href='amagstatus.php?id=",$row['con_id'],"'>approved</a>";

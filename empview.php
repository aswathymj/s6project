...
th,td{
  ...
  <section class="home-section">
    ...
    <div style="margin-left:-190px">
              ...
              <table  class="table1" border="2"  id="tab"  width="250%",height="200%">
                <thead>
                    <tr>
            ...
            <th>Phone</th>
                ...
                <?php
                  require("connection.php");
                        ...
                        $query1="select emp_id,name,email,address,exp,ph,image from tmp_emp" ;
            ...
            <td><?php echo $row1['ph'];?></td>
						<td><img src="<?php echo $row1['image'];?>" width="80" height="60"></td>
						 ...
						 <input type="hidden" name="emp_id" id="<?php  $row1['emp_id']?>">
						  <th><?php echo"<a href='empup.php?id=$row1[emp_id]'>"?><font color="red" class="btns1">Edit</font></th>
                           </form> 
                      </tr>
                    </thbody>
                    <?php

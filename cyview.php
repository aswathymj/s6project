...
<h1><br><b >View Product</h1></b><br>
           <table align="center" border="2"  id="tab" align="left" width="200%",height="240%">
                <thead>
                    <tr>
                ...
                <?php
                 require("connection.php");
                        ...
                        $query1="select cyl_id,cyl_name,cyl_desc,cyl_price,cyl_image from tbl_cyl" ;
                    ...
                    <thbody>
					  ...
					  <td><img src="<?php echo $row1['cyl_image']; ?>" width="80" height="60"></td>
                          ...
                          <form action="cyldel.php" method="POST">
						  <input type="hidden" name="cyl_id" value="<?php echo $row1['cyl_id']?>">
						  <th><input type="submit" name="delete" class="btns2" value="Delete"></th>
                           </form> 
						 <form action="cylup.php" method="POST">
						 <input type="hidden" name="cyl_id" id="<?php  $row1['cyl_id']?>">
						  <th><?php echo"<a href='cylup.php?id=$row1[cyl_id]'>"?><font color="red" class="btns1">Edit</font></th>
                           </form> 
